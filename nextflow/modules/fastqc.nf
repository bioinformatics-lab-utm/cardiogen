process FASTQC {
    ...
    publishDir "${params.outdir}/01_QC/${meta.run}/raw_data", mode: 'copy', pattern: "*_fastqc.html"
    publishDir "${params.outdir}/01_QC/${meta.run}/raw_data/plots", mode: 'copy', pattern: "*/Images/*.png"
